...
*-------------------------Updating panel-------------------------*
SELECTION-SCREEN BEGIN OF BLOCK bk6 WITH FRAME TITLE TEXT-015.
  SELECTION-SCREEN BEGIN OF LINE.
    SELECTION-SCREEN COMMENT 1(15) TEXT-004 MODIF ID id5.
    PARAMETERS: p_kunnr4 TYPE kna1-kunnr MODIF ID id5.
  SELECTION-SCREEN END OF LINE.

  SELECTION-SCREEN BEGIN OF LINE.
    SELECTION-SCREEN COMMENT 1(15) TEXT-005 MODIF ID id5.
    PARAMETERS: p_land12 TYPE kna1-land1 MODIF ID id5.
  SELECTION-SCREEN END OF LINE.

  SELECTION-SCREEN BEGIN OF LINE.
    SELECTION-SCREEN COMMENT 1(15) TEXT-006 MODIF ID id5.
    PARAMETERS: p_name12 TYPE kna1-name1 MODIF ID id5.
  SELECTION-SCREEN END OF LINE.

  SELECTION-SCREEN BEGIN OF LINE.
    SELECTION-SCREEN COMMENT 1(15) TEXT-007 MODIF ID id5.
    PARAMETERS: p_ort012 TYPE kna1-ort01 MODIF ID id5.
  SELECTION-SCREEN END OF LINE.

  SELECTION-SCREEN BEGIN OF LINE.
    SELECTION-SCREEN COMMENT 1(15) TEXT-008 MODIF ID id5.
    PARAMETERS: p_pstlz2 TYPE kna1-pstlz MODIF ID id5.
  SELECTION-SCREEN END OF LINE.
...
SELECTION-SCREEN BEGIN OF BLOCK bk7 WITH FRAME TITLE TEXT-013.
  SELECTION-SCREEN BEGIN OF LINE.
    ...
    PARAMETERS: p_kunnr5 TYPE kna1-kunnr MODIF ID id6.
  SELECTION-SCREEN END OF LINE.
